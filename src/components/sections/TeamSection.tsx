...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        // Bigger, photo-friendly circles
        "z-10 flex h-24 w-24 sm:h-28 sm:w-28 lg:h-32 lg:w-32 items-center justify-center rounded-full border-2 bg-white p-2 overflow-hidden shadow-[0_0_28px_-10px_rgba(0,0,0,0.8)]",
        className,
      )}
    >
      {children}
    ...
    >
      ...
      >
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div1Ref}>
            {/* Replace icon with passport photo if you want */}
            {/* <img src="/team/member1.jpg" className="h-full w-full object-cover" /> */}
            <Icons.googleDrive />
          </Circle>
          <Circle ref={div5Ref}>
            <Icons.googleDocs />
